...
public class CouchDbConsts {
	...
	public static final String SENS_ACT_ATTR_DB = "SensorActiveAttributesDB";
	public static final String REQUESTS_DB = "RequestsDB";
	public static final String ALLOCATION_DB = "AllocationDB";
}
