...
public class ThingDeserializer extends JsonDeserializer<Thing>{
	...
	@Override
	public Thing deserialize(JsonParser jp,
...
//				if(fieldName.equals("batteryLevel")){
//					t.setBatteryLevel(getBattery(jp));
//				}else if(fieldName.equals("coordinates")){
//					t.setCoords(getCoords(jp));
//				}else if(fieldName.equals("servicesList")){
//					t.setServicesList(getServicesList(jp));
//				}
