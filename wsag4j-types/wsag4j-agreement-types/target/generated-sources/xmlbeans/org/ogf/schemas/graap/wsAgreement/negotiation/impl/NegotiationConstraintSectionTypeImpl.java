 ...
 */
public class NegotiationConstraintSectionTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationConstraintSectionType
{
    private static final long serialVersionUID = 1L;
    
    public NegotiationConstraintSectionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ITEM$0 = 
        new javax.xml.namespace.QName("http://schemas.ogf.org/graap/2009/11/ws-agreement-negotiation", "Item");
     ...
     */
    public org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType[] getItemArray()
    {
        synchronized (monitor())
        {
            ...
            org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType[] result = new org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType[targetList.size()];
     ...
     */
    public org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType getItemArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType target = null;
            target = (org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType)get_store().find_element_user(ITEM$0, i);
            if (target == null)
            {
     ...
     */
    public void setItemArray(org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType[] itemArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setItemArray(int i, org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType item)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType insertNewItem(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType target = null;
            target = (org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType)get_store().insert_element_user(ITEM$0, i);
            return target;
        }
    }
     ...
     */
    public org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType addNewItem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType target = null;
            target = (org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferItemType)get_store().add_element_user(ITEM$0);
            return target;
        }
    }
