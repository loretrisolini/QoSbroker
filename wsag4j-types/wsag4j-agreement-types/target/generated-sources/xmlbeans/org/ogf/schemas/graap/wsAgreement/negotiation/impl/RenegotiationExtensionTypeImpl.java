 ...
 */
public class RenegotiationExtensionTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.ogf.schemas.graap.wsAgreement.negotiation.RenegotiationExtensionType
{
    private static final long serialVersionUID = 1L;
    
    public RenegotiationExtensionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName RESPONDERAGREEMENTEPR$4 = 
        new javax.xml.namespace.QName("http://schemas.ogf.org/graap/2009/11/ws-agreement-negotiation", "ResponderAgreementEPR");
    private static final javax.xml.namespace.QName NEGOTIATIONOFFERCONTEXT$6 = 
    ...
    public org.w3.x2005.x08.addressing.EndpointReferenceType getResponderAgreementEPR()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x2005.x08.addressing.EndpointReferenceType target = null;
            target = (org.w3.x2005.x08.addressing.EndpointReferenceType)get_store().find_element_user(RESPONDERAGREEMENTEPR$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setResponderAgreementEPR(org.w3.x2005.x08.addressing.EndpointReferenceType responderAgreementEPR)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.w3.x2005.x08.addressing.EndpointReferenceType)get_store().add_element_user(RESPONDERAGREEMENTEPR$4);
            }
    ...
    public org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferContextType getNegotiationOfferContext()
    {
        synchronized (monitor())
        {
            ...
            target = (org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferContextType)get_store().find_element_user(NEGOTIATIONOFFERCONTEXT$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setNegotiationOfferContext(org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferContextType negotiationOfferContext)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.ogf.schemas.graap.wsAgreement.negotiation.NegotiationOfferContextType)get_store().add_element_user(NEGOTIATIONOFFERCONTEXT$6);
            }
